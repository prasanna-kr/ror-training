...
class DevelopersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create developer" do
    assert_difference('Developer.count') do
      post developers_url, params: { developer: { beer_id: @developer.beer_id, name: @developer.name } }
    end
  ...
  test "should update developer" do
    patch developer_url(@developer), params: { developer: { beer_id: @developer.beer_id, name: @developer.name } }
